...
void joystickRead(){
  ...
  sendData.joyData[0] = readJoystickADS(0); // XL
  sendData.joyData[1] = readJoystickADS(1); // YL
  sendData.joyData[2] = readJoystickADS(2); // XR
  sendData.joyData[3] = readJoystickADS(3); // YR
